...
for key, lang in LANGUAGES.items():
    print(f"Язык: {lang}; Аббривиттура: {key}")

choose_lang = input("Какой язык вы хотите выбрать? Напишите aббривиаттуру(Например: ru): ").lower().strip()

translate_text = Translator().translate(full_article, dest=choose_lang).text
